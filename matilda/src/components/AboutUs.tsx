...
import mainsiteImg from '../assets/mainsite.jpg';

export const AboutUs: React.FC = () => {
  const { openShop } = useCollection();
  const [imageSrc, setImageSrc] = useState<string>(mainsiteImg);
  ...
  const handleImageError = () => {
    if (imageSrc !== '/mainsite.jpg') {
      setImageSrc('/mainsite.jpg');
    } else if (imageSrc !== '/assets/mainsite.jpg') {
      setImageSrc('/assets/mainsite.jpg');
    }
  };
