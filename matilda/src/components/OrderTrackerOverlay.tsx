      ...
      <div className="pt-4 border-t border-[var(--border-main)]">
        {loading && !statusData ? (
          ...
          <div className="text-sm font-micro lowercase">
            {statusData.status === 'pending' && <p className="text-amber-600">your payment is being verified. you will receive your order confirmation shortly with the order number for tracking.</p>}
