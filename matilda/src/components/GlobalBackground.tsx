    ...
    >
      ...
      <div className="absolute inset-0 w-full h-full opacity-75 transition-opacity duration-700">
        ...
        <motion.div
          ...
          className={`absolute -top-1/4 -left-1/4 w-[70vw] h-[70vw] max-w-[800px] max-h-[800px] rounded-full blur-[90px] sm:blur-[140px] pointer-events-none mix-blend-multiply ${
            collection === 'men' ? 'bg-red-950/40' : 'bg-[#7A1228]/20'
          }`}
        />
        ...
        <motion.div
          ...
          className={`absolute -bottom-1/4 -right-1/4 w-[65vw] h-[65vw] max-w-[750px] max-h-[750px] rounded-full blur-[100px] sm:blur-[150px] pointer-events-none mix-blend-multiply ${
            collection === 'men' ? 'bg-amber-950/30' : 'bg-[#B88A4E]/18'
          }`}
        />
        ...
        <motion.div
          ...
          className={`absolute top-1/3 left-1/4 w-[50vw] h-[50vw] max-w-[600px] max-h-[600px] rounded-full blur-[80px] sm:blur-[120px] pointer-events-none mix-blend-soft-light ${
            collection === 'men' ? 'bg-purple-950/20' : 'bg-[#8C1C33]/15'
          }`}
        />
      </div>
