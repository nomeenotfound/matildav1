        ...
        >
          ...
          <div className="flex flex-col justify-between max-h-[calc(90vh-16rem)] md:max-h-[90vh] overflow-hidden bg-[var(--bg-primary)]">
            ...
            <div className="p-5 sm:p-6 overflow-y-auto space-y-4 flex-1">
              {/* Product Header: Category, In Stock & Title (pr-12 ensures clear clearance from the top-right close icon) */}
              <div className="pr-10 sm:pr-12 space-y-1.5">
                <div className="flex items-center justify-between gap-2">
                  ...
                  <span className="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-semibold bg-emerald-500/10 text-emerald-700 border border-emerald-500/20 lowercase">
                    in stock
                  </span>
                </div>
