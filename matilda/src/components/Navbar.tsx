...
export const Navbar: React.FC = () => {
  ...
  const isCheckout = location.pathname === '/app/checkout' || location.pathname === '/checkout';
  ...
  return (
    <>
      ...
      <header className={`sticky md:fixed ${saleActive && !isCheckout ? 'md:top-8' : 'top-0'} left-0 right-0 md:left-auto z-40 w-full md:w-auto transition-all duration-300 md:p-6 pointer-events-none md:pointer-events-auto`}>
