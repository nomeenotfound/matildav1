  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="fixed inset-0 z-50 flex flex-col items-center justify-center p-6 sm:p-8 bg-[#2B050B]/60 backdrop-blur-md text-[var(--text-primary)]"
      >
            ...
            >
              ...
              <div className="border border-[var(--border-main)]/50 p-4 text-[11px] space-y-2 bg-white/80 rounded-2xl text-left shadow-xs lowercase">
                <div className="flex justify-between border-b border-[var(--border-main)]/30 pb-2">
                  <span className="font-semibold text-[var(--text-muted)]">subtotal</span>
