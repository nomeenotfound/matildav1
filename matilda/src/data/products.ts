...
export const PRODUCTS: Product[] = [
  // --- WOMEN'S (IVORY COLLECTION) ---
  {
    ...
    variants: [
      { id: 'v1', name: '16 inch', inStock: true },
      { id: 'v2', name: '18 inch', inStock: true },
      { id: 'v3', name: '20 inch', inStock: true },
    ],
    isFeatured: true,
  ...
  },
  {
    ...
    variants: [
      { id: 'v1', name: '300 ml', inStock: true },
      { id: 'v2', name: '400 ml', inStock: true },
    ],
    isFeatured: false,
  ...
  },
  {
    ...
    variants: [
      ...
      { id: 'v3', name: 'size 8', inStock: true },
    ],
    isFeatured: true,
    hasVictorianFrame: true,
  ...
  },
  {
    ...
    variants: [
      { id: 'v1', name: 'small', inStock: true },
      { id: 'v2', name: 'medium', inStock: true },
      { id: 'v3', name: 'large', inStock: true },
    ],
    isFeatured: false,
    hasVictorianFrame: false,
  ...
  },
  {
    ...
    variants: [
      { id: 'v1', name: 'blank pages', inStock: true },
      { id: 'v2', name: 'dotted pages', inStock: true },
    ],
    isFeatured: false,
    hasVictorianFrame: true,
  ...
  // --- MEN'S (CHARCOAL LEDGER) ---
  {
    ...
    variants: [
      { id: 'v1', name: 'size 9', inStock: true },
      { id: 'v2', name: 'size 10', inStock: true },
      { id: 'v3', name: 'size 11', inStock: true },
    ],
    isFeatured: true,
    hasVictorianFrame: true,
  ...
  },
  {
    ...
    variants: [
      { id: 'v1', name: 'medium', inStock: true },
      { id: 'v2', name: 'large', inStock: true },
      { id: 'v3', name: 'xlarge', inStock: true },
    ],
    isFeatured: true,
    hasVictorianFrame: false,
  ...
  },
  {
    ...
    variants: [
      { id: 'v1', name: 'S/M', inStock: true },
      { id: 'v2', name: 'L/XL', inStock: true },
    ],
    isFeatured: false,
    hasVictorianFrame: true,
  ...
  },
  {
    ...
    variants: [
      { id: 'v1', name: 'dark charcoal', inStock: true },
      { id: 'v2', name: 'deep espresso', inStock: true },
    ],
    isFeatured: false,
    hasVictorianFrame: false,
  ...
  },
  {
    ...
    variants: [
      { id: 'v1', name: 'standard wax', inStock: true },
    ],
    isFeatured: false,
    hasVictorianFrame: true,
