...
const firebaseConfig = {
  ...
  projectId: getEnv('VITE_FIREBASE_PROJECT_ID') || getEnv('FIREBASE_PROJECT_ID') || getEnv('GOOGLE_CLOUD_PROJECT') || '',
...
export function getGoogleFirestore(): Firestore | null {
  ...
  if (firebaseConfig.projectId) {
    try {
      ...
      console.warn("Google Cloud Firestore client initialization notice:", err);
    }
  }
  return null;
}
